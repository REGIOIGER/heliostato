...
*/
				...
				// Pruebas de angulos, supone elevacion inicial cero y angulo azimutal relativo
				// mAZ y mEL estan en radianes
/*
int i;
for(i = 0; i <= 60; i+=10){
	angEL = deg2rad(i + 7.7); 
	updateMotorEL(rad2len(angEL, M1CL, M1CC )); //revisa limites en radianes de el angulo de elevacion
	usdelay(65535);
	usdelay(65535);
	usdelay(65535);
	usdelay(65535);
...
UART_TX("\r\nInicia prueba de control de angulo azimutal: ");
int i;
for(i = 0; i <= 90; i+=10){
	angAZ = deg2rad(i + 33); 
	...
	updateMotorAZ(rad2len(angAZ, M2CL, M2CC )); //revisa limites en radianes de el angulo de elevacion
	usdelay(65535);
	usdelay(65535);
	usdelay(65535);
	usdelay(65535);
